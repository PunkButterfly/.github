...
* [Marking Hack](https://github.com/PunkButterfly/Hackathon-MarkingHack) - система предиктивной аналитики рынка и поиска финансовых и логистических аномалий - 3 место :3rd_place_medal:
* [Xmas Hack](https://github.com/PunkButterfly/Hackathon-XmasHack) - определение вида договора с интерпретацией результата. Второй трофей для нашей команды - 1 место :trophy:
* [Skolkovo Hack](https://github.com/PunkButterfly/Hackathon-Skolkovo) - ранжирование кандидатов по соответствию вакансиям. Жили вместе двое суток и победили - 1 место :trophy:
...
* [Best Hack](https://github.com/PunkButterfly/Hackathon-BestHack) - недельный хакатон от Бауманки. Не прошли в финал, так как решили вместо рабочего метода кластеризации отослать три строчки с двумя ифами 🤪
...
Новый сезон 2022-2023 мы начали с двух побед и призерства!
